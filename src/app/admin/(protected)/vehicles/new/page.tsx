  ...
  return (
    <div className="max-w-2xl">
      ...
      <p className="mt-1 text-sm text-graphite-500">
        Paste image URLs from Cloudinary, one per line. The first one becomes the cover photo
        shown on the vehicle card — you can change this later from the edit page.
      </p>
